...
public class AimAssist extends Module {
    ...
    private Entity getTarget(Rotation rotation) {
        ...
        for (Entity entity2 : getMc().world.getEntities()) {
            if (isEntityValid(entity2) && Prestige.Companion.getAntiBotManager().isNotBot(entity2) && (entity2 instanceof PlayerEntity player && !Prestige.Companion.getSocialsManager().isFriend(player.getName().getString()))) {
    ...
    public String method224() {
        ...
        if (target == null) {
            ...
            string = target.getName().getString();
        } else {
            string = "Crystal";
        }
        return string;
